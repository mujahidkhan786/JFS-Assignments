...
public class StreamsQ2 {
    ...
    public static void main(String[] args) {
        News news1 = new News(1, "Mujahid", "Afridi", "comment");
        News news2 =new News(2, "Mujahid1", "Afridi1", "budget");
        News news3 = new News(1, "Mujahid2", "afridi2", "comment");
        News news4 = new News(3, "Mujahid3", "Afridi", "budget");
        News news5 = new News(1, "Mujahid4", "Afridi2", "comment");
        News news6 = new News(3, "Mujahid5", "Afridi", "budget");
        News news7 = new News(1, "Mujahid6", "Afridi6" ,"comment");
