...
public class StreamsQ4 {
    ...
    public static void main(String[] args) {
        Trader t1 = new Trader("Mujahid11", "Bangalore");
        Trader t2 = new Trader("Mujahid22", "Pune");
        Trader t3 = new Trader("Mujahid33", "Bangalore");
        Trader t4 = new Trader("Mujahid44", "Delhi");
        Trader t5= new Trader("Mujahid55", "Chennai");

        Trader t6 = new Trader("Mujahid66", "Pune");
        Trader t7 = new Trader("Mujahid77", "Delhi");
        Trader t8 = new Trader("Mujahid88", "Delhi");
        Trader t9 = new Trader("Mujahid99", "Pune");
